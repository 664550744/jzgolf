...
class Keditor extends CI_Controller {
	...
	public function upload_json()
	{
		...
		$php_path = APPPATH.'libraries/Services_JSON.php';
		...
		//文件保存目录路径
		$save_path = WEBPATH . '/uploads/'.$b_uid.'/';
		//文件保存目录URL
		$save_url = $php_url . '/uploads/'.$b_uid.'/';
	...
	public function file_manager_json()
	{
		...
		$root_path = WEBPATH . '/uploads/'.$b_uid.'/';
		//根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
		$root_url = $php_url . '/uploads/'.$b_uid.'/';
		//图片扩展名
